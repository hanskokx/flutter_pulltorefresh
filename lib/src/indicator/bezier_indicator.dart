...
class _BezierHeaderState extends RefreshIndicatorState<BezierHeader>
  ...
  Future<void> readyToRefresh() {
    final Simulation simulation = SpringSimulation(
      const SpringDescription(mass: 3.4, stiffness: 10000.5, damping: 6),
  ...
  Future<void> endRefresh() async {
    ...
    return _bezierDismissCtl.animateTo(
      1.0,
      ...
      child: SlideTransition(
        ...
        child: AlignTransition(
          alignment: _childMoveCtl.drive(
            _childMoveTween as Animatable<AlignmentGeometry>,
          ),
