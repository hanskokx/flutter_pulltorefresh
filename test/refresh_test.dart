  ...
  group("trigger refresh function test", () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.pumpAndSettle(const Duration(milliseconds: 600));
        expect(
          refreshController.position!.pixels == positionRecord - 60.0,
          true,
        ); //60.0 is indicator  visual extent
